...
void GUI::DisplayAnimationPixelDestroy(){   // play destroy animation
                        ...
                        // Ausgabe
                        for(int16_t currentBlock=0; currentBlock < totalBlocks; currentBlock++)
                            {
                            _tft.fillRect(blockPositions[currentBlock][0], blockPositions[currentBlock][1], 8, 8, TFT_BLACK
                            );
