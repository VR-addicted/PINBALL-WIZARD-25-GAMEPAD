...
def update_clangd_config():
    ...
    # Die .clangd Datei komplett neu schreiben
    # HIER fügen wir jetzt alle Flags ein, die Clangd NICHT mag
...
"""
    ...
    print(f"--- [Clangd-Fix] .clangd wurde mit erweitertem Filter aktualisiert ---")
